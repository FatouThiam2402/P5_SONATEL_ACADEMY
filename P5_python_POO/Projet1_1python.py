...
class lesFonctions:
    ...
    #math[12.0: 13.0: 10.0]#pc[13.0: 18.5: 19.75]#
    ...
    def afficherInfoValides(self,list_valides):
        print(53*"-")
    ...
    def afficherUneNote(self,numero,liste_note_val,liste_note_inval):
        print(53*"-")
    ...
    def ajouterInfo(self):
        note=""
        devoir = []
        numero = lesFonctions.numeroValide(self,input("Donner votre numero\n"))
        if numero == False:
            print("Le numero est invalide")
        nom = lesFonctions.nomValide(self,input("Donner Votre nom\n"))
        if nom == False:
            print("Le nom saisi n'est pas correcte car < 2\n")
        prenom = lesFonctions.prenomValide(self,input('Donner Votre prenom\n'))
        if prenom == False:
            print("Le prenom saisi n'est pas correcte car < 3\n")
        forma_date = lesFonctions.changerFormatDate(self,input("Donner Votre date de naissance\n"))
        if forma_date == False:
            print("la date est invalide\n ")
        else:    
            date = lesFonctions.dateValide(self,forma_date)
            if date == False:
                print("La date est incorrecte\n")
            else:
                pass    
        forma_classe = lesFonctions.definirFormatClasse(self,input("Donner votre nom de classe\n"))
        if forma_classe == False:
            print("La classe n'existe pas")
        classe = lesFonctions.classeValide(self,forma_classe)
        if classe == False:
        ...
        while nbr_matieres > 0:
            ...
            devoir =[]
        note1 = note.replace(',',';')
        noteF = lesFonctions.noteValide(self,note1)
        if noteF == False:
